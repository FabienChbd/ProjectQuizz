...
switch(scoreBeer){
    case 0:
        ...
        break;
    case 1:
        scoreFinal.textContent = `Désolé ${pseudo}, mais apparemment tu ne connais que toi-même, car l'ours n'a eu qu'une seule bière. L'ours va donc te dévorer.`;
        break;
    case 2:
    case 3:
    case 4:
    case 5:
    case 6:
        scoreFinal.textContent = `Désolé ${pseudo}, mais l'ours n'a eu que ${scoreBeer} bières. Tu ne connais pas assez sa promo, il va donc te considérer comme son futur repas. COURS VITE !!!`;
        break;
    case 7:
    case 8:
    case 9:
